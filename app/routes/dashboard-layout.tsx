    ...
    <div className="dash-shell">
      ...
      <aside className="dash-sidebar">
        ...
        <div className="dash-sidebar-footer">
          <NavLink to="/dashboard/profile" className="dash-user-row dash-user-row-link">
            ...
            <svg className="shrink-0 text-slate-500" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="dash-body">
        <header className="dash-topbar">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <span className="dash-avatar-sm" aria-hidden="true">{initials}</span>
              <span className="hidden sm:block">
                <span className="type-caption block text-right text-slate-400">Signed in as</span>
                <span className="type-caption block text-right text-slate-200">
                  {user.displayName ?? user.email}
                </span>
              </span>
            </NavLink>
